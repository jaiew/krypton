...
public class InternetExplorerSeleniumLocatorStrategiesTest extends AbstractSeleniumLocatorStrategiesTest {
    protected BrowserSession createBrowserSession() {
        return Browsers.IE.create();
    }

    protected String referenceErrorMessage(String reference) {
        return Browsers.IE.referenceError(reference);
    }
}
