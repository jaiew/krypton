...
public class MozillaSeleniumLocatorStrategiesTest extends AbstractSeleniumLocatorStrategiesTest {
    protected BrowserSession createBrowserSession() {
        return Browsers.MOZILLA.create();
    }

    protected String referenceErrorMessage(String reference) {
        return Browsers.MOZILLA.referenceError(reference);
    }
}
