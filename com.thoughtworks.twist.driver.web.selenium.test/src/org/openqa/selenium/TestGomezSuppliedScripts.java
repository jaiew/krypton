...
public class TestGomezSuppliedScripts extends SeleneseTestCase {
    public void testRC108() throws Exception {
    ...
    public void testRC112() throws Exception {
        selenium.open("https://www.webperform.com/ui/");
    }

    public void testRC169() throws Exception {
        selenium.open("http://www.friendster.com/join.php");
        selenium.click("link=Log In");
        selenium.waitForPageToLoad("30000");
    }

    public void testRC188() throws Exception {
        selenium.open("http://www.google.com");
        assertTrue(selenium.isVisible("q"));
    }

    public void testRC210() throws Exception {
    ...
    public void testRC294() throws Exception {
